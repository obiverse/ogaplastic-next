        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="reveal relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl px-6 py-4 shadow-xl">
              <div className="text-3xl font-bold text-teal-deep font-display">
                Est.
              </div>
          ...
          <div className="reveal">
            ...
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-teal-deep mb-6">
              Nigeria&apos;s Trusted{" "}
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-8">
              {VALUES.map((value, i) => (
                <div
                  key={value.title}
                  className="card-hover bg-white rounded-xl p-5 border border-light-grey"
                >
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <h4 className="font-semibold text-teal-deep text-sm">
                        {value.title}
                      </h4>
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-teal pl-5 py-2">
                <h4 className="text-sm font-semibold text-teal-deep mb-1">
                  Our Mission
                </h4>
